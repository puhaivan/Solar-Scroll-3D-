...
const PLANET_DESCRIPTION: Record<PlanetNameWithoutDefault, PlanetDescription> =
  {
    ...
    earth: {
      description:
        'Earth is the only planet known to support life, with diverse ecosystems and climates.',
      diametr: 12742,
      moons: 1,
      temperature: 15,
      atmosphere: 'N₂, O₂',
    ...
    mars: {
      description:
        'Mars is a dusty, cold desert world with signs of ancient water flows.',
      diametr: 6779,
      moons: 2,
      temperature: -65,
      atmosphere: 'CO₂, N₂, Ar',
    ...
    jupiter: {
      description:
        'Jupiter is the largest planet, known for its Great Red Spot and many moons.',
      diametr: 139820,
      moons: 79,
      temperature: -110,
      atmosphere: 'H₂, He',
    ...
    saturn: {
      description:
        'Saturn is famous for its stunning ring system and is the second-largest planet.',
      diametr: 116460,
      moons: 83,
      temperature: -140,
      atmosphere: 'H₂, He',
    ...
    neptune: {
      description:
        'Neptune is a deep blue planet with supersonic winds and distant, icy conditions.',
      diametr: 49244,
      moons: 14,
      temperature: -200,
      atmosphere: 'H₂, He, CH₄',
